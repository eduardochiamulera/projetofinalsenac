...
namespace Evian.Repository.Migrations
{
    ...
    [Migration("20211001222112_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Evian.Entities.Entities.Banco", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Evian.Entities.Entities.Categoria", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.Cidade", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.ConciliacaoBancaria", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.ConciliacaoBancariaItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.ConciliacaoBancariaItemContaFinanceira", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.CondicaoParcelamento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.ContaBancaria", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.ContaFinanceira", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid?>("ContaFinanceiraParcelaPaiId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("ContaFinanceiraRepeticaoPaiId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ContaFinanceiraParcelaPaiId");

                    b.HasIndex("ContaFinanceiraRepeticaoPaiId");

                    b.HasIndex("FormaPagamentoId");

                    b.HasIndex("PessoaId");

                    b.ToTable("conta_financeira");
                });

            modelBuilder.Entity("Evian.Entities.Entities.ContaFinanceiraBaixa", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.Estado", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.FormaPagamento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.MovimentacaoFinanceira", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("ContaFinanceiraId")
                        .IsUnique()
                        .HasFilter("[ContaFinanceiraId] IS NOT NULL");

                    b.ToTable("movimentacao");
                });

            modelBuilder.Entity("Evian.Entities.Entities.Pais", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.Pessoa", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.SaldoHistorico", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.Categoria", b =>
                {
                    b.HasOne("Evian.Entities.Entities.Categoria", "CategoriaPai")
                        .WithMany()
            ...
            modelBuilder.Entity("Evian.Entities.Entities.Cidade", b =>
                {
                    b.HasOne("Evian.Entities.Entities.Estado", "Estado")
                        .WithMany()
            ...
            modelBuilder.Entity("Evian.Entities.Entities.ConciliacaoBancaria", b =>
                {
                    b.HasOne("Evian.Entities.Entities.ContaBancaria", "ContaBancaria")
                        .WithMany()
            ...
            modelBuilder.Entity("Evian.Entities.Entities.ConciliacaoBancariaItem", b =>
                {
                    b.HasOne("Evian.Entities.Entities.ConciliacaoBancaria", "ConciliacaoBancaria")
            ...
            modelBuilder.Entity("Evian.Entities.Entities.ConciliacaoBancariaItemContaFinanceira", b =>
                {
                    b.HasOne("Evian.Entities.Entities.ConciliacaoBancariaItem", "ConciliacaoBancariaItem")
                        .WithMany("ConciliacaoBancariaItemContasFinanceiras")
                        .HasForeignKey("ConciliacaoBancariaItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Evian.Entities.Entities.ContaFinanceiraBaixa", "ContaFinanceiraBaixa")
                        .WithMany()
                        .HasForeignKey("ContaFinanceiraBaixaId");

                    b.HasOne("Evian.Entities.Entities.ContaFinanceira", "ContaFinanceira")
                        .WithMany()
            ...
            modelBuilder.Entity("Evian.Entities.Entities.ContaBancaria", b =>
                {
                    b.HasOne("Evian.Entities.Entities.Banco", "Banco")
                        .WithMany()
            ...
            modelBuilder.Entity("Evian.Entities.Entities.ContaFinanceira", b =>
                {
                    b.HasOne("Evian.Entities.Entities.Categoria", "Categoria")
                        .WithMany()
                        .HasForeignKey("CategoriaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Evian.Entities.Entities.CondicaoParcelamento", "CondicaoParcelamento")
                        .WithMany()
                        .HasForeignKey("CondicaoParcelamentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Evian.Entities.Entities.ContaFinanceira", "ContaFinanceiraParcelaPai")
                        .WithMany()
                        .HasForeignKey("ContaFinanceiraParcelaPaiId");

                    b.HasOne("Evian.Entities.Entities.ContaFinanceira", "ContaFinanceiraRepeticaoPai")
                        .WithMany()
                        .HasForeignKey("ContaFinanceiraRepeticaoPaiId");

                    b.HasOne("Evian.Entities.Entities.FormaPagamento", "FormaPagamento")
                        .WithMany()
                        .HasForeignKey("FormaPagamentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Evian.Entities.Entities.Pessoa", "Pessoa")
                        .WithMany()
                    ...
                    b.Navigation("ContaFinanceiraParcelaPai");

                    b.Navigation("ContaFinanceiraRepeticaoPai");
            ...
            modelBuilder.Entity("Evian.Entities.Entities.Estado", b =>
                {
                    b.HasOne("Evian.Entities.Entities.Pais", "Pais")
                        .WithMany()
            ...
            modelBuilder.Entity("Evian.Entities.Entities.MovimentacaoFinanceira", b =>
                {
                    b.HasOne("Evian.Entities.Entities.ContaBancaria", "ContaBancariaDestino")
                        .WithMany()
                        .HasForeignKey("ContaBancariaDestinoId");

                    b.HasOne("Evian.Entities.Entities.ContaBancaria", "ContaBancariaOrigem")
                        .WithMany()
                        .HasForeignKey("ContaBancariaOrigemId");

                    b.HasOne("Evian.Entities.Entities.ContaFinanceira", "ContaFinanceira")
                        .WithOne("MovimentacaoFinanceira")
                        .HasForeignKey("Evian.Entities.Entities.MovimentacaoFinanceira", "ContaFinanceiraId");
            ...
            modelBuilder.Entity("Evian.Entities.Entities.Pessoa", b =>
                {
                    b.HasOne("Evian.Entities.Entities.Cidade", "Cidade")
                        .WithMany()
            ...
            modelBuilder.Entity("Evian.Entities.Entities.SaldoHistorico", b =>
                {
                    b.HasOne("Evian.Entities.Entities.ContaBancaria", "ContaBancaria")
                        ...
                        .HasForeignKey("Evian.Entities.Entities.SaldoHistorico", "ContaBancariaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
