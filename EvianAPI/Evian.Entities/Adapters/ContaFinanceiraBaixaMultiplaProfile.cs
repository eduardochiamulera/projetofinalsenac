...
{
    public class ContaFinanceiraBaixaMultiplaProfile : Profile
    {
        public ContaFinanceiraBaixaMultiplaProfile()
        {
            CreateMap<ContaFinanceiraBaixaMultiplaDTO, ContaFinanceiraBaixaMultipla>()
