...
{
    public class ConciliacaoBancariaItemContaFinanceiraProfile : Profile
    {
        public ConciliacaoBancariaItemContaFinanceiraProfile()
        {
            CreateMap<ConciliacaoBancariaItemContaFinanceiraDTO, ConciliacaoBancariaItemContaFinanceira>()
